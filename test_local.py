...
def main():
    ...
    try:
        ...
        location_success = test_location_monitoring()
        
        # Test global monitoring
        global_success = test_global_monitoring()
        
        # Test manual notifications
        manual_success = test_manual_notifications()
        
        # Test Slack integration
        slack_success = test_slack_integration()
        
        # Restore original status
        restore_success = restore_original_status()
